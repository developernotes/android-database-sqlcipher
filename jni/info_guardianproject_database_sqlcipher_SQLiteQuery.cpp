...
static jint nativeFillWindow(JNIEnv* env, jclass clazz, jint databasePtr,
    ...
    if (offsetParam > 0) {
        ...
        if (err != SQLITE_OK) {
            ...
            guardianproject::throw_sqlite3_exception(env, database);
            return 0;
        }
        ...
        if (err == SQLITE_ROW) {
            ...
            for (int i = 0; i < numColumns; i++) {
                ...
                if (type == SQLITE_TEXT) {
                    ...
                    guardianproject::throw_sqlite3_exception(env, "Unknown column type when filling window");
                    gotException = true;
                    break;
                }
            }
            ...
            if (retryCount > 50) {
                ...
                guardianproject::throw_sqlite3_exception(env, database, "retrycount exceeded");
                gotException = true;
            } else {
